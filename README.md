...
- **Compatibility checks**: Apache + GPL-2-only, EPL + GPL, CDDL + GPL, etc. — displayed with loud `!`-banner warnings; correctly treats `GPL-2.0 WITH Linux-syscall-note` as compatible with later GPL versions
